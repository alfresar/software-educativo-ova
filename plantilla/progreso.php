                            ...
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <p>Realizado: Si</p>
                                        <p>Fecha: 14/07/2022</p>
                                        <p>Tiempo: 14 minutos</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                <div class="card mb-4">
                                    <div class="card-body">Actividad #5</div>
                                    <div class="card-footer">
                                        <p>Tema: Objeto virtuales de aprendizaje: OVA</p>
                                        <p>Tipo: Quiz</p>
                                        <p>Realizado: Si</p>
                                        <p>Fecha: 20/07/2022</p>
                                        <p>Tiempo: 9 minutos</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-4">
                                <div class="card mb-4">
                                    <div class="card-body">Actividad #6</div>
                                    <div class="card-footer">
                                        <p>Tema: Herramientas para desarrollar un OVA</p>
                                        <p>Tipo: Sopa de letras</p>
                                        <p>Realizado: No</p>
                                        <p>Fecha: 24/07/2022</p>
                                        <p>Tiempo: 0 minutos</p>
                                    </div>
                                </div>
                            </div>
