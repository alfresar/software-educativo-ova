                            ...
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <p>Por otra parte, los OVA se enmarcan en los propósitos de las herramientas TIC, las cuales están produciendo cambios en las metodologías de enseñanza y aprendizaje, en la forma en que los profesores y estudiantes se relacionan con el conocimiento, y la manera en que interactúan los agentes involucrados en el proceso educativo (Cabrera, 2014).</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    <div class="card-body">Los OVA en la educación virtual</div>
                                    <div class="card-footer">
                                       <p>La estructura general de los OVA contiene un objetivo, un contenido, una actividad de aprendizaje y un mecanismo de evaluación. Este recurso didáctico es independiente, es decir, es creado para ser reutilizable en variados contextos educativos y en distintos dispositivos.</p>

                                       <p>Los OVA se pueden desarrollar en diversos formatos como: HTML, XML, JPEG, PDF, Flash, GIF, etc., que sean compatibles con distintos programas. Es recomendable que se estructure bajo un paquete de estandarización, como SCORM.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                       <p><ul>
                                           ...
                                           <li>Compatibles: su compatibilidad con otros estándares sin inconvenientes técnicos al utilizarlos.</li>
                                           <li>Estructurados: con una interfaz fácil de utilizar y explorar por el usuario, contando con un diseño atractivo.</li>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <p><link rel="stylesheet" type="text/css" href="">
                                            <a target="_blank" href="https://www.youtube.com/watch?v=5NWQ3jqWx3w">¿Qué es un OVA? -Objeto Virtual de Aprendizaje-</a>
                                        </p>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <p>Link de Acceso: <a target="_blank" href="#">OVA (Objeto virtuales de aprendizaje)</a></p>
                                        <p>Fecha Inicio: 21/07/2022</p>
                                        <p>Fecha Fin: 21/07/2022</p>
